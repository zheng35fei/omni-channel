    ...
    <div class="addMenu">
        ...
        >
            <FormItem label="名称：" prop="funName">
                <Input v-model="formItem.funName" placeholder="填写菜单名称" style="width:33%;" />
            </FormItem>
            ...
            <FormItem label="父ID：" prop="parentId">
                <Input v-model="formItem.parentId" style="width:33%;" />
            </FormItem>
            <FormItem label="所属类型：">
            ...
            <FormItem label="标识：">
                <Input v-model="formItem.optType" style="width:33%;" />
            </FormItem>
            <FormItem label="排序：" prop="sortNo">
                <Input v-model="formItem.sortNo" style="width:33%;" number />
            </FormItem>
