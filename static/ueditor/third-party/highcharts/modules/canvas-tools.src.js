 ...
 * @link   http://testwww.phpied.com/rgb-color-parser-in-javascript/
 ...
 *
 * Requires: rgbcolor.js - http://testwww.phpied.com/rgb-color-parser-in-javascript/
 *
 */
if(!window.console) {
	window.console = {};
...
(function(){
	...
	function build() {
		...
		svg.AspectRatio = function(ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY, refX, refY) {
			// aspect ratio - http://testwww.w3.org/TR/SVG/coords.html#PreserveAspectRatioAttribute
		...
		svg.Element.path = function(node) {
			...
			// TODO: convert to real lexer based on http://testwww.w3.org/TR/SVG11/paths.html#PathDataBNF
				...
				while (!pp.isEnd()) {
					...
					case 'A':
						while (!pp.isCommandOrEnd()) {
							...
							// http://testwww.w3.org/TR/SVG11/implnote.html#ArcImplementationNotes
							// x1', y1'
