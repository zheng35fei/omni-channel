...
var UNDEFINED,
	...
	SVG_NS = 'http://testwww.w3.org/2000/svg',
...
/**
 * Based on http://testwww.php.net/manual/en/function.strftime.php
 * @param {String} format
...
defaultOptions = {
	...
	credits: {
		enabled: true,
		text: 'Highcharts.com',
		href: 'http://testwww.highcharts.com',
		position: {
			align: 'right',
			x: -10,
			verticalAlign: 'bottom',
...
SVGRenderer.prototype = {
	...
	image: function (src, x, y, width, height) {
		...
		if (elemWrapper.element.setAttributeNS) {
			elemWrapper.element.setAttributeNS('http://testwww.w3.org/1999/xlink',
				'href', src);
		} else {
...
if (useCanVG) {
	...
	Highcharts.CanVGRenderer = CanVGRenderer = function () {
		...
		SVG_NS = 'http://testwww.w3.org/1999/xhtml';
	};
