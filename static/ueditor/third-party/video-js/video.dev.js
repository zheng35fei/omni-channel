...
vjs.createEl = function(tagName, properties){
  ...
  for (propName in properties){
    if (hasOwnProp.call(properties, propName)) {
      ...
      // http://testwww.w3.org/TR/wai-aria-primer/#ariahtml. Using setAttribute gets around this problem.
 ...
 * http://testwww.foliotek.com/devblog/getting-the-width-of-a-hidden-element-with-jquery-using-width/
 *
 ...
 *
 *     myPlayer.src("http://testwww.example.com/path/to/video.mp4");
 *
 * **Source Object (or element):** A javascript object containing information
 * about the source file. Use this method if you want the player to determine if
 * it can support the file using the type information.
 *
 *     myPlayer.src({ type: "video/mp4", src: "http://testwww.example.com/path/to/video.mp4" });
 *
 ...
 *
 *     myPlayer.src([
 *       { type: "video/mp4", src: "http://testwww.example.com/path/to/video.mp4" },
 *       { type: "video/webm", src: "http://testwww.example.com/path/to/video.webm" },
 *       { type: "video/ogg", src: "http://testwww.example.com/path/to/video.ogv" }
 *     ]);
 *
 ...
 * http://testwww.w3.org/html/wg/drafts/html/master/embedded-content-0.html#dom-media-texttracks
 ...
 * http://testwww.w3.org/html/wg/drafts/html/master/embedded-content-0.html#dom-media-addtexttrack
